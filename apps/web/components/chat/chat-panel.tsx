      ...
      >
        {message.context_file_id && (
          <div className="flex items-center gap-1.5 mb-1.5 opacity-70">
            ...
            <span className="text-xs">File context active</span>
          </div>
        )}
...
export function ChatPanel() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-blue-600 hover:bg-blue-500 rounded-full flex items-center justify-center shadow-lg shadow-blue-500/20 transition z-50"
      >
  ...
  return (
    <div className="w-96 h-full flex flex-col bg-zinc-950 border-l border-zinc-800">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800">
        <div className="flex items-center gap-2">
          <MessageSquare className="w-5 h-5 text-blue-400" />
          <span className="font-medium text-zinc-200 text-sm">AI Assistant</span>
        </div>
      ...
      {contextFile && (
        <div className="flex items-center gap-2 px-4 py-2 bg-blue-500/10 border-b border-zinc-800">
          ...
          <span className="text-xs text-blue-300 truncate flex-1">
            Context: {contextFile.original_name}
          </span>
          <button
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
        {messages.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-zinc-500 text-sm">Ask me anything about your data</p>
            <div className="mt-4 space-y-2">
              {[
                ...
                <button
                  ...
                  className="block w-full text-left text-xs text-zinc-500 hover:text-zinc-300 px-3 py-2 rounded-lg hover:bg-zinc-800/50 transition"
                >
                  &quot;{q}&quot;
                </button>
              ))}
